...
{
    /* si la fecha del pago es mayor al año, ya está vencido y retorna true. 
    Y, si es igual al año, me fijo que el mes no se supere. 
    Si se superó, está vencido y retorna true.*/
